...
|cyclic_peptide:<br/>&nbsp;&nbsp;&nbsp;&nbsp;MPI_sort_by | "energy" |   String| The MPI version of the helical_bundle_predict app has the option of writing out the top N% of solutions.  This determines the sort metric. |
