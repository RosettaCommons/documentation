...
| aa_repeat | [[AARepeatEnergy|Repat-stretch-energy]] | A term that discourages repeat sequences.  Useful for designing when structural characterization is to be carried out by NMR spectroscopy, since repeat sequences are difficult to assign. | No.  (Term is packer-compatible, though). | No.  (Term is disregarded by minimizer.) |
