...
```
<ResidueCount name=(&string) max_residue_count=(Inf &Integer) min_residue_count=(0 &Integer) residue_types=("" &string) />
```
...
```
<NetCharge name=(&string) min=(-100 &Integer) max=(100 &Integer) chain=(0 &Integer) />
```
...
Should work with *most* ligands via Lucas Nivan's recent commit.
