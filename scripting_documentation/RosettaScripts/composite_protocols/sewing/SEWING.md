...
1. [[Segment File Generation|segment-file-generation]] - Extraction of secondary structure units from native structures
    ...
    [[Structural Comparison of Substructures|structural-comparison-of-substrucutres]] ( Hashed SEWING only ) - Structurally compare substructures to one another using a geometric hashing algorithm
