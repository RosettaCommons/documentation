...
```
<EnzRepackMinimize name="(string)" task_operations="(string)" task_factory="(string)"
         cycles="(non_negative_integer; 1)" min_in_stages="(bool; false)" design="(bool; false)"
         repack_only="(bool; false)" fix_catalytic="(bool; false)" cst_opt="(bool; false)"
         backrub="(bool; false)" minimize_rb="(bool; true)" minimize_bb="(bool; false)"
         minimize_sc="(bool; true)" minimize_lig="(bool; false)" minimize_prot_jumps="(bool; false)"
         scorefxn_repack="(string)" scorefxn_minimize="(string)" rb_min_jumps="(nnegative_int_cslist)"
         />
```
