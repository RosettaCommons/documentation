...
<Disulfidize name="(string)"scorefxn="(string)"match_rt_limit="(real; 2.0)"
        min_disulfides="(non_negative_integer)"
        max_disulfides="(non_negative_integer)"
        keep_current_disulfides="(bool; false)"
        include_current_disulfides="(bool; false)"
        min_loop="(non_negative_integer; 8)"max_disulf_score="(real; 1.5)"
        mutate_gly="(bool; false)"mutate_pro="(bool; false)"
        max_cb_dist="(real; 5)"score_or_matchrt="(bool; false)"set1="(string)"
        set2="(string)"use_l_cys="(bool; true)"use_d_cys="(bool; false)" />
```
