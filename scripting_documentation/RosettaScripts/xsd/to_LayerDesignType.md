...
<LayerDesign name="(string)" use_original_non_designed_layer="(bool; true)"
    ...
    <core >
        <all copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)"
        ...
        <HelixCapping copy_layer="(string)" aa="(string)" ncaa="(string)"
                ...
                ncaa_exclude="(string)" operation="(layer_design_operation_behavior)"
                specification="(layer_design_specification_behavior)" />
        <HelixStart copy_layer="(string)" aa="(string)" ncaa="(string)"
                append="(string)" ncaa_append="(string)" exclude="(string)"
                ncaa_exclude="(string)" operation="(layer_design_operation_behavior)"
                specification="(layer_design_specification_behavior)" />
        <Loop copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)"
                ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)"
                operation="(layer_design_operation_behavior)"
                specification="(layer_design_specification_behavior)" />
