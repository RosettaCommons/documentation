...
```
<LayerDesign name="(string)" use_original_non_designed_layer="(bool; true)" layer="(string; core_boundary_surface_Nterm_Cterm)" repack_non_design="(bool; true)" ignore_pikaa_natro="(bool; false)" use_sidechain_neighbors="(bool)" sc_neighbor_dist_midpoint="(real)" sc_neighbor_denominator="(real)" sc_neighbor_angle_shift_factor="(real)" sc_neighbor_angle_exponent="(real)" sc_neighbor_dist_exponent="(real)" pore_radius="(real)" core="(real)" surface="(real)" core_E="(real)" core_L="(real)" core_H="(real)" surface_E="(real)" surface_L="(real)" surface_H="(real)" make_rasmol_script="(bool)" blueprint="(string)" use_symmetry="(bool; true)" verbose="(bool; false)" restrict_restypes="(bool; true)" make_pymol_script="(bool; false)" >
    <core >
        <all copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
        <Helix copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
        <HelixCapping copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
        <HelixStart copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
        <Loop copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
        <Strand copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
    </core>
    <boundary >
        <all copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
        <Helix copy_layer="(string)" aa="(string)" ncaa="(string)" append="(string)" ncaa_append="(string)" exclude="(string)" ncaa_exclude="(string)" operation="(layer_design_operation_behavior)" specification="(layer_design_specification_behavior)" />
...
For subtag core: XRW TO DO



For subtag all: XRW TO DO
...
For subtag HelixCapping: XRW TO DO
...
For subtag HelixStart: XRW TO DO
...
For subtag CombinedTasks: XRW TO DO
...
For subtag TaskLayer: XRW TO DO
