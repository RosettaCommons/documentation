...
```
<ParsedProtocol name="(string)" mode="(mode_types; sequence)" filter_name="(string; true_filter)"
         filter="(string; true_filter)" apply_probability="(real)" report_at_end="(bool; true)"
