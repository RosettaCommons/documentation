...
<SelectBySASA name="(string)" mode="(SelectBySASAOperation_mode_choices; sc)"
         state="(SelectBySASAOperation_state_choices; monomer)" probe_radius="(real; 2.2)"
         core_asa="(real; 0)" surface_asa="(real; 30)" jumps="(int_cslist; 1)"
         sym_dof_names="(string; XRW TO DO)" core="(bool; false)" boundary="(bool; false)"
         surface="(bool; false)" verbose="(bool; false)" />
```
