...
```xml
<LegacyEnumerateAssemblyMover name="(&string;)" model_file="(&string;)"
        score_file="(&string;)" min_segments="(0 &non_negative_integer;)"
        max_segments="(50 &non_negative_integer;)" base_native_bonus="(&real;)"
        neighbor_cutoff="(&non_negative_integer;)" min_assembly_score="(&real;)" >
    <GlobalRequirements >
...
-   **min_assembly_score**: Minimum assembly score cutoff (-2.0 recommended)
