...
```
<CDRDihedralConstraintMover name="(string)" cdr="(string)" use_cluster_csts="(bool)"
         use_general_constraints_on_failure="(bool)" force_cluster="(cluster_definitions)"
         cluster_data_required="(real)" use_outliers="(real)" general_phi_sd="(real)"
         general_psi_sd="(real)" />
```
