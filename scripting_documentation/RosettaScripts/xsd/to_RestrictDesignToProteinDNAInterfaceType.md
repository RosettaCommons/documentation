...
```
<RestrictDesignToProteinDNAInterface name="(string)" dna_defs="(string)" base_only="(bool)"
         z_cutoff="(real)" close_threshold="(real)" contact_threshold="(real)"
         forget_chains_and_interface="(bool)" />
```
