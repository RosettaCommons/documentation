...
```
<MotifGraft name="(string)" context_structure="(string)" motif_structure="(string)"
         RMSD_tolerance="(real)" NC_points_RMSD_tolerance="(real; 340282346638528859811704183484516925440.000000)"
         clash_score_cutoff="(non_negative_integer)" combinatory_fragment_size_delta="(string)"
         max_fragment_replacement_size_delta="(string)" clash_test_residue="(clash_test_residue_names)"
         hotspots="(string)" full_motif_bb_alignment="(bool; false)" allow_independent_alignment_per_fragment="(bool; false)"
         graft_only_hotspots_by_replacement="(bool; false)" only_allow_if_N_point_match_aa_identity="(bool; false)"
         only_allow_if_C_point_match_aa_identity="(bool; false)" revert_graft_to_native_sequence="(bool; false)"
