...
```
<Ddg name="(string)"threshold="(real; -15)"jump="(positive_integer; 1)"
        repeats="(positive_integer; 1)"repack="(bool; 1)"symmetry="(string)"
        repack_bound="(bool; 1)"relax_bound="(bool; 0)"
        translate_by="(real; 100)"relax_mover="(string)"filter="(string)"
        chain_num="(string)"extreme_value_removal="(bool; false)"
