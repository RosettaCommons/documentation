...
```
<TryRotamers name="(string)" pdb_num="(residue_number)" res_num="(non_negative_integer)" automatic_connection="(bool; 1)" scorefxn="(string)" jump_num="(non_negative_integer; 1)" solo_res="(bool; 1)" final_filter="(string; true_filter)" clash_check="(bool; 0)" include_current="(bool; 1)" explosion="(non_negative_integer; 0)" shove="(refpose_enabled_residue_number_cslist)" />
```
