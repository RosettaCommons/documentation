...
```
<InterfacePacking name="(string)" distance_cutoff="(real; 9.0)" contact_dist="(real; 10.0)"
         lower_cutoff="(real; -5)" upper_cutoff="(real; 5)" sym_dof_names="(string)"
         multicomp="(bool; 0)" confidence="(real; 1.0)" />
```
