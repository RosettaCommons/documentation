...
```xml
<EvolutionaryDynamics name="(&string;)" trials="(10 &non_negative_integer;)"
        ...
        population_size="(1000000 &positive_integer;)"
        disable_fitness_evaluation="(false &bool;)"
        branch_length="(1000000 &real;)" mutation_rate="(0.001 &real;)" >
    <Filters >
...
-   **branch_length**: Set branch_length.
