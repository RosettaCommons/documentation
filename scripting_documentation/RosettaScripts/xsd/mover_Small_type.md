...
```
<Small name="(string)" temperature="(real)" nmoves="(non_negative_integer)" angle_max="(real; 6.0)"
         preserve_detailed_balance="(bool)" scorefxn="(string)" residue_selector="(string)"
         >
