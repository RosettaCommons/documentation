...
-   CHI\_RANGE | The number of CHI\_RANGE fields needs to equal the values specified for NUM\_CHI, expressed as CHINUMBER STARTVAL ENDVAL INCREMENT, where CHINUMBER specifies which CHI angle, the first is closest to the  alpha carbon. 
