...
-   **Native structure:**
     ...
     See `        integration/tests/flexpepdock/input/1ER8.pdb       ` for an example in Refinement mode, or `        protocol_capture/FlexPepDock_AbInitio/input_file/2b1z.native.pdb       ` for *ab-initio* mode.
