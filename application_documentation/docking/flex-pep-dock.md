...
Rosetta fragment picker is used to assign fragments consistent with the predicted secondary structure and sequence profile to the vall database of high-resolution protein fragments:
    ...
    ```
    $fragment_picker.linuxgccrelease -database rosetta_database -in:file:vall vall.jul19.2011 -in:file:checkpoint 
    pep_seq.checkpoint -frags:frag_sizes 6 -frags:n_candidates	2000 -frags:n_frags 50 -frags:ss_pred 
    pep_seq.psipred_ss2 psipred -frags:scoring:config psi_L1.cfg -frags:bounded_protocol true
    ```
