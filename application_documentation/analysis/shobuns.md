...
````
\<AMINO\> is a one-letter amino acid code. If \<AMINO\> is the string _any_, then the application will evaluate all polar atoms named \<ATOM\> in all residues that have one.
