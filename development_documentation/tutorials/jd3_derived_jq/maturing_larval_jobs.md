...
###complete_larval_job_maturation()
This method is more-or-less unique to your specific protocol.
This is where you create a Job that can be run based off of the limited information the head queen gives you.
```c++
JobOP
