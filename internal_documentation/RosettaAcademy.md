...
#### Foldit (developed by Center for Game Science at UW, Bakerlab, and UMass Dartmouth)
...
* exception: developer can define exit if error occurs, but exit is not always necessary
