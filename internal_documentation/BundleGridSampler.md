...
Default parameter values or parameter ranges are set in the <b>BundleGridSampler</b> tag, and overrides are set in the individual <b>Helix</b> tags.  Refer to the [[MakeBundleMover]] for options that both movers have in common.  Additional options include:
