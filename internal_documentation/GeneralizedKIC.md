...
<MOVERS>
...
     <GeneralizedKIC name="&string" closure_attempts=(2000 &int) stop_if_no_solution=(0 &int) stop_when_solution_found=(false &bool) selector="&string" selector_scorefunction="&string" contingent_filter="&string">
          ...
     </GeneralizedKIC>
...
</MOVERS>
