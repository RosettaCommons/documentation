...
## (to be moved to better location later) Design with Sewing-derived-native-bonus
When backbones were generated by Sewing, native rotamers are saved with file name as xxx.rot.
Therefore, one can give some bonus to these Sewing-derived-native-rotamers when designing sidechains by AssemblyConstraintsMover.
